...
# CCM v0.54.7 — End-to-end Step 2 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_by_Son_v0.54.7\tests\arcpy_smoke_test.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.46 — Step 2 arcpy smoke test")
    print("=" * 64)
