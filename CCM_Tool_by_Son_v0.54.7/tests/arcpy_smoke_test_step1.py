...
# CCM v0.54.7 — End-to-end Step 1 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_by_Son_v0.54.7\tests\arcpy_smoke_test_step1.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.54.7 — Step 1 arcpy smoke test (Project Setup & Pre-process)")
    print("=" * 64)
