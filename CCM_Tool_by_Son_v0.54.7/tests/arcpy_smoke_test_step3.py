...
# CCM v0.54.7 — End-to-end Step 3 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
# Companion to tests/arcpy_smoke_test.py (Step 2), arcpy_smoke_test_step0.py,
...
#
# Builds the same proven 3x3-grid fixture as tests/arcpy_smoke_test.py, runs
...
#     exec(open(r"C:\...\CCM_Tool_by_Son_v0.54.7\tests\arcpy_smoke_test_step3.py").read())
...
#
VERSION = "0.54.7"  # v0.54.7 — fixed the SA-vs-vector path detection itself (see CHANGELOG_v0.54.md).
...
def build_fixtures(root):
    """Same proven 3x3-grid fixture as tests/arcpy_smoke_test.py."""
...
def main():
    print("=" * 64)
    print("  CCM v0.54.7 — Step 3 arcpy smoke test (Advanced Analysis)")
    print("=" * 64)
