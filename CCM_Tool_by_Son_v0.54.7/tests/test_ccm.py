...
# ===========================================================================
# TEST MODULE: CCM_Tool_by_Son_v0.54.7.pyt helpers
# ===========================================================================

class TestCCMHelpers:
    """Tests for utility functions in CCM_Tool_by_Son_v0.54.7.pyt."""
    ...
    def pyt_mod(self):
        ...
        pyt_path = os.path.join(_ROOT, "CCM_Tool_by_Son_v0.54.7.pyt")
...
class TestProjectConfig:
    ...
    def test_save_and_load_roundtrip(self, cfg_mod, tmp_path):
        ...
        assert loaded["ccm_version"] == "0.54.7"
