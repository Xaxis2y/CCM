...
# ===========================================================================
# TEST MODULE: CCM_Tool_by_Son_v0.54.1.pyt helpers
# ===========================================================================

class TestCCMHelpers:
    """Tests for utility functions in CCM_Tool_by_Son_v0.54.1.pyt."""
    ...
    def pyt_mod(self):
        ...
        pyt_path = os.path.join(_ROOT, "CCM_Tool_by_Son_v0.54.1.pyt")
        loader = SourceFileLoader("CCM_Tool_by_Son_v0_47", pyt_path)
        spec = importlib.util.spec_from_loader("CCM_Tool_by_Son_v0_47", loader)
...
class TestProjectConfig:
    ...
    def test_version_is_047(self, cfg_mod):
        assert cfg_mod.VERSION == "0.54.1"
    ...
    def test_save_and_load_roundtrip(self, cfg_mod, tmp_path):
        ...
        assert loaded["ccm_version"] == "0.54.1"
...
class TestObstacleDetect:
    ...
    def test_version_is_047(self, od_mod):
        assert od_mod.VERSION == "0.54.1"
...
class TestStep2Mobility:
    ...
    def test_version_is_049(self, m):
        assert m.VERSION == "0.54.1"
...
class TestSpatialMoisture:
    ...
    def test_version_is_049(self, w):
        assert w.VERSION == "0.54.1"


# ===========================================================================
# TEST MODULE: ccm_coords CRS/projection smart-warning helpers (v0.54.1)
# ===========================================================================
...
class TestCoordsCRSHelpers:
    ...
    def test_version_is_054(self, c):
        assert c.VERSION == "0.54.1"
