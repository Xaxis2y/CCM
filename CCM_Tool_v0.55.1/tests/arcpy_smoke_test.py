...
# CCM v0.55.1 — End-to-end Step 2 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_v0.55.1\tests\arcpy_smoke_test.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.55.1 — Step 2 arcpy smoke test (Generate Mobility Map)")
    print("=" * 64)
