...
# CCM v0.55.1 — End-to-end Step 0 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_v0.55.1\tests\arcpy_smoke_test_step0.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.55.1 — Step 0 arcpy smoke test (Load MGCP Data)")
    print("=" * 64)
