...
# CCM v0.55.1 — End-to-end Step 1 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_v0.55.1\tests\arcpy_smoke_test_step1.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.55.1 — Step 1 arcpy smoke test (Project Setup & Pre-process)")
    print("=" * 64)
