...
`CCM_Tool_v0.56.0_User_Manual.docx`.
...
- The `CCM_Tool_v0.56.0` folder on disk (this folder)
...
3. Navigate to this folder and select `CCM_Tool_v0.56.0.pyt`.
...
- `ERROR 000384` (Union licence limit) — fixed as of v0.54.4; make sure
  you're on v0.56.0, not an older unpatched copy.
