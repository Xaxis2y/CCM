...
# CCM v0.56.0 — End-to-end Step 2 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_v0.56.0\tests\arcpy_smoke_test.py").read())
# Option B — ArcGIS Pro conda prompt:
#     "%PROGRAMFILES%\ArcGIS\Pro\bin\Python\envs\arcgispro-py3\python.exe" tests\arcpy_smoke_test.py
#
...
# cleanly; run directly (python tests/arcpy_smoke_test.py) the import still
...
def main():
    print("=" * 64)
    print("  CCM v0.56.0 — Step 2 arcpy smoke test (Generate Mobility Map)")
    print("=" * 64)
