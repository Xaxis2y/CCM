...
# CCM v0.56.0 — End-to-end Step 3 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
...
#     exec(open(r"C:\...\CCM_Tool_v0.56.0\tests\arcpy_smoke_test_step3.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.56.0 — Step 3 arcpy smoke test (Advanced Analysis)")
    print("=" * 64)
