#!/usr/bin/env python3
"""
CCM Tool v0.58 — Data Auto-Selection Engine
...
<title>CCM Data Recommendations v0.58</title>
<style>
...
<body>
<header class="hero">
<h1>CCM Data Recommendations v0.58</h1>
<p>Auto-selected sources for mobility modeling</p>
</header>
<main>
...
{''.join(self._render_role_recommendations(recommendations.get('selections', {})))}

{self._render_warnings_section(recommendations.get('warnings', []))}
...
<div class="footer">Generated {recommendations.get('timestamp', 'Unknown')} | CCM Tool v0.58 | Data Intelligence & Auto-Selection</div>
</main>
</body>
</html>
"""
    ...
    def _render_role_recommendations(self, selections: Dict[str, Any]) -> str:
...
""")
    ...
    def _render_warnings_section(self, warnings: List[str]) -> str:
