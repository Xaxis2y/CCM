...
# CCM v0.57 — End-to-end Step 1 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
# Companion to tests/arcpy_smoke_test_step2.py (Step 2 only) and
...
#     exec(open(r"C:\...\CCM_Tool_v0.57\tests\arcpy_smoke_test_step1.py").read())
...
def build_fixtures(root):
    ...
    slope_pct) — mirroring tests/arcpy_smoke_test_step2.py's proven fixture.
    """
...
def main():
    print("=" * 64)
    print("  CCM v0.57 — Step 1 arcpy smoke test (Project Setup & Pre-process)")
    print("=" * 64)
