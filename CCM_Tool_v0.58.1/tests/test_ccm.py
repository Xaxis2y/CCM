...
# ===========================================================================
# TEST MODULE: CCM_Tool_v0.57.pyt — Toolbox registration
# ===========================================================================
...
class TestProjectConfig:
    ...
    def test_save_and_load_roundtrip(self, cfg_mod, tmp_path):
        ...
        assert loaded["ccm_version"] == "0.57"
...
class TestArcpyIntegration:
    ...
    def test_toolbox_loads(self):
        ...
        pyt_path = os.path.join(_ROOT, "CCM_Tool_v0.57.pyt")
