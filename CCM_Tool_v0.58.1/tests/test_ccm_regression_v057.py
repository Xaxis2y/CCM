#!/usr/bin/env python3
"""
CCM Tool v0.58 — Regression Test Suite (Phase 4)

Verifies backward compatibility: all v0.57 functionality still works
after v0.58 scoring engine addition. Tests core catalog building,
...
class TestCatalogBuildingRegression:
    ...
    def test_catalog_preserves_v057_outputs(self):
        """v0.58 should not delete v0.57 output files."""
        output_files = {
...
class TestProjectConfigRegressionV057:
    ...
    def test_project_config_backward_compatible(self):
        """v0.58 config with new keys should not affect v0.57 reads."""
        v057_config = {
            "project_name": "Test",
        ...
        assert v057_config["project_name"] == v058_enhanced["project_name"], \
            "v0.57 keys should be unchanged in v0.58 config"
