...
# -*- coding: utf-8 -*-
"""
CCM_Tool_v0.58.2.pyt — ArcGIS Python Toolbox entry point
====================================================
...
v0.57 changes (this file):
  - Integrated the validated Data Intelligence Step 0b tool between Step 0
    ...
    reporting while preserving the existing Steps 0-4 workflow. v0.58.2 adds
    quality, fitness, confidence, readiness, and reviewable recommendations.
    See CHANGELOG_v0.58.2.md and TOOLBOX_INTEGRATION.md.
...
# Tool metadata
toolname    = "CCM_Tool"
toolversion = "0.58.2"  # v0.58.2 -- bumped by bump_version.py from v0.57. Review this line's comment.
