...
rem CCM Tool v0.58.2 - dedicated standalone Anaconda environment
...
echo [CCM v0.58.2] Preparing dedicated environment: %ENV_NAME%
...
rem v0.58.2 post-review: this used to just PRINT "conda activate %ENV_NAME%" as
...
echo Next verification command: RUN_V0582_TESTS.bat
exit /b 0
