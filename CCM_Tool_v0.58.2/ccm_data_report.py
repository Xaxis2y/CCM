...
"""Factual text and HTML reports for CCM Data Intelligence v0.58.2.
...
def render_text(catalog, width=88):
    ...
    lines.extend([
        ...
        "",
        "Methodology note: this report is the factual inventory subreport in "
        "v0.58.2. Quality, Fitness, Confidence, Readiness, and recommendation "
        "results are written to their separate Step 0b output files; this "
        "factual subreport does not calculate an automatic best-source "
...
def render_html(catalog):
    ...
    parts.append("<footer>CCM Data Intelligence v%s &middot; factual inventory subreport &middot; "
                 "scoring and recommendations are separate outputs.</footer>" %
