...
# CCM v0.57 — End-to-end Step 0 validation on a REAL ArcGIS Pro installation.
#
# WHAT THIS DOES
# --------------
# Companion to tests/arcpy_smoke_test_step2.py (which covers Step 2 only).  This
...
#     exec(open(r"C:\...\CCM_Tool_v0.57\tests\arcpy_smoke_test_step0.py").read())
...
def main():
    print("=" * 64)
    print("  CCM v0.57 — Step 0 arcpy smoke test (Load MGCP Data)")
    print("=" * 64)
