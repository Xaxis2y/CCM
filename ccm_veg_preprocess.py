...
# CCM Vegetation Data Preprocessor — v2.12
...
class CCMVegPreprocessTool:
    ...
    Appears in the MCE CCM Toolbox V2 as tool "0b. Pre-process Vegetation Data".
    ...
    def execute(self, parameters, messages):
        ...
        if result.success:
            ...
            arcpy.AddError(
                "[CCM Veg Preprocess]  Processing failed — "
